...
def help(update: Update, context: CallbackContext):
	text = "Это бот, который случайным образом выдаёт пользователю интересные факты русского языка.\n\n\
	- *Заимстования* - факты о словах, пришедших в русский из других языков\n\
	...
	- *Орфоэпия* - факты, связанные с нормами современного русского ударения.\n\
	- *РКИ* - факты, связанные с изучением русского языка как иностранного \n\
	...
	- *Типология* - факты, описывающие русский язык в мире языкового разнообразия.\n\
	...
	- *Этимология* - факты, связанные с историей происхождения некоторых слов современного русского языка.\n\n\
	*Доступные команды:*\n\
